...
class _MyHomePageState extends State<MyHomePage> {
  Future<void> _createPDF() async {
    ...
    var imageData =
        (await rootBundle.load('assets/images/laudo.png')).buffer.asUint8List();
    final anexos = pw.MemoryImage(imageData);
    ...
    imageData = (await rootBundle.load('assets/images/rubrica.png'))
        .buffer
        .asUint8List();
              ...
              children: [
                pw.Column(
                  children: [
                        ...
                        children: [
                          ...
                          pw.Column(
                              ...
                              children: [
                                ...
                                pw.Text(
                                    "Laboratório de Análises Biológicas ME ",
                                    style:  const pw.TextStyle(
                                        color: PdfColors.orange, fontSize: 12)),
                    ...
                    pw.Center(
                      child: pw.Image(anexos, width: 200, height: 200),
                    ),
